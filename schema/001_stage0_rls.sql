-- =====================================================================
-- Stage 0 — roles, row-level security, audit log
-- Adapt table and column names to the real schema before applying.
-- Apply to STAGING first. Test with a Google account that is NOT in
-- team_members, then apply to production.
-- =====================================================================
...
-- ---------------------------------------------------------------------
-- 5. Harden the existing RPCs
--    Every upsert_* function must check the caller instead of trusting
--    the p_by argument. Pattern:
--
